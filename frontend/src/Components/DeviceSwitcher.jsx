...
export default function DeviceSwitcher({ compact = false }) {
  ...
  const wrapClass = compact
    ...
    : 'flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl shadow-2xl';
      ...
      {devices.map((device) => {
        ...
        return (
          <button
            ...
            className={`group relative ${btnPad} rounded-full transition-all duration-300 flex items-center justify-center
