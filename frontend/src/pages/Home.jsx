...
export default function Home() {
  ...
  return (
    <div className="min-h-screen h-full bg-[var(--bg-main)] text-[var(--text-main)] flex flex-col font-sans selection:bg-[var(--accent)]/30 transition-colors duration-500 relative">
      ...
      {/* Preferences — in document flow (no overlap with footer) */}
      <section className="relative z-10 w-full px-6 py-4 border-t border-white/5">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4">
          <div className="flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-xl">
            <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-[var(--text-dim)] border-r border-white/10 pr-3">
      ...
      {/* Footer */}
      <footer className="relative z-10 px-8 py-3 border-t border-white/5 text-center text-gray-500 text-[9px]">
